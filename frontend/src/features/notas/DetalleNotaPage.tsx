 ...
 * - Edición y eliminación condicionadas por rol y ventana de edición reactiva
          ...
          {puedeEditar && (
            <div className="flex gap-2">
              ...
              <Button
                ...
                title={accDesha ? "Plazo de edición vencido" : "Editar nota"}
              >
              ...
              <Button
                ...
                title={accDesha ? "Plazo de eliminación vencido" : "Eliminar nota"}
              >
